...
public class InternalServerErrorException extends ResponseStatusException implements Serializable {
    ...
    public InternalServerErrorException(String message, ResultListDTO<ResultResponseDTO> data) {
